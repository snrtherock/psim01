#!/bin/bash
# creation script for vol1 on archivepool01 and vol2 of archivepool02
#
############################################################
...
#
stmfadm add-view -h xpool-archive1-2hg $uuid
#
...
# remember to create the view with a reference to the host group
#
stmfadm add-view -h xpool-archive1-2hg $uuid2
#
# stmfha update archivepool02 # use this if RSF-1 is installed and running
#
