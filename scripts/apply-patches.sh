...
#mount 192.168.2.161:/export/users/xs-hostfixes /mnt/xshotfixes
...
then 
	...
	then
		...
		PATCHUUID=$(xe patch-upload file-name=/opt/stratatron/etc/$PATCH)
...
done < "/opt/stratatron/etc/manifest"
